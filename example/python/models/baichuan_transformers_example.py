...
model_path = "/root/download/baichuan2-7b-chat/"
int8_ckpt_path = "/root/download/baichuan2-7b-chat/eet_baichuan_int8.pt"
fp16_ckpt_path = "/root/download/baichuan2-7b-chat/eet_baichuan_fp16.pt"
...
def save_dict():
    ...
    eet_baichuan_dict = convert_baichuan_weights(ts_model.state_dict(), data_type=torch.float16)
    print("*******************after quant*****************")
    for k, v in eet_baichuan_dict.items():
        print(k, v.shape)
    torch.save(eet_baichuan_dict, fp16_ckpt_path)

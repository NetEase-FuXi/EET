#ifndef _OP_LLAMA_MMHA_HPP_
#define _OP_LLAMA_MMHA_HPP_
...
namespace eet{
    namespace op{
        ...
        class LlamaMmha : public OpBase{
        public:
            LlamaMmha(MetaDesc desc,
        ...
        private:
            ...
            void fused_RoPE_transpose(const Buffer &qkv_buffer,
                                      Buffer &q_buf,
                                      Buffer &k_buf,
                                      Buffer &v_buf,
                                      int time_step);
